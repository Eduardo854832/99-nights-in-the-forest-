...
function UI.applyLanguage()
    ...
    -- Atualiza texto dos botões da sidebar
...
function UI.createRoot()
    ...
    close.BackgroundColor3=Themes._current.accent
    close.Text="X"
    ...
    Themes.register(close,"accent")

    local minimize=Instance.new("TextButton")
    minimize.Size=UDim2.new(0,34,0,34)
    minimize.Position=UDim2.new(1,-88,0.5,-17)
    minimize.BackgroundColor3=Themes._current.accent
    minimize.Text="-"
    ...
    Themes.register(minimize,"accent")
    ...
    content.Size=UDim2.new(1,-SIDEBAR_WIDTH-16,1,-48-16)
    content.Position=UDim2.new(0,SIDEBAR_WIDTH+12,0,60)
    ...
    -- Criar botões da sidebar e contêineres vazios
    ...
    -- Seleciona primeiro painel
    task.defer(function()
        UI.selectPanel(UI._panelOrder[1])
    end)
end

-- Componentes reutilizados (adaptados para novo layout)
